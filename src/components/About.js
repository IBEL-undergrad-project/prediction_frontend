...
function About({ contract }) {
  return (
    <div>
      <div>
        <h3>이 프로젝트에 대해 알려주세요!</h3>
        <p>
          2022년 대선 후보 중 최종당선자를 예측하는 예측 시장 프로젝트입니다.
      ...
      <div>
        ...
        <p>
          <i>
            식 : 총상금(A+B+C+D) / 해당 후보에게 모인 배팅 금액 * 개인이 베팅한
            금액 * 0.99
          </i>
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          프로젝트들의 코드는 투명하지 않아서 그들이 표방하는 알고리즘대로
          상금을 지급하는지에 대한 신뢰성 문제를 항상 가지고 있습니다.
        </p>
        <p>
          ...
          해결할 수 있습니다. 코드가 궁금하신 분들은 다음 ropsten.ethersan.io에
          접속하셔서 밑에 있는 컨트랙트 주소로 검색하시면 모든 코드를 투명하게
          보실 수 있습니다.
        </p>
